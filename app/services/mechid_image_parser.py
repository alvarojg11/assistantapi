...
def _build_image_instructions(catalog: Dict[str, object]) -> str:
    ...
    return (
        ...
        "Return JSON only.\n"
        "This is usually a lab screenshot, report image, or scanned isolate susceptibility report for a single patient isolate.\n"
        "Your job is to read the visible organism name, susceptibility results, and any clearly stated treatment context.\n"
        "The image may show gram-negatives, staphylococci, enterococci, streptococci, anaerobes, or mycobacteria.\n"
        ...
        "Do not assume the report is gram-negative or carbapenemase-focused.\n"
        "Populate visibleText with a concise plaintext transcription of the clinically meaningful visible lines, especially organism name, AST rows, and any carbapenemase rows or labels.\n"
        "Use resistancePhenotypes for explicit labels like MRSA, MSSA, MR-CoNS, VRE, VRSA, penicillin-resistant pneumococcus, ESBL, CRE, KPC, NDM, VIM, IMP, or OXA-48-like.\n"
        ...
        "Recognize common gram-positive AST markers and phenotype rows such as oxacillin, nafcillin, cefoxitin, vancomycin, daptomycin, linezolid, penicillin, ceftriaxone, clindamycin, erythromycin, tetracycline, trimethoprim/sulfamethoxazole, D-test, PBP2a, mecA, mecC, and vanA/vanB.\n"
        "If a row clearly indicates methicillin resistance or susceptibility, vancomycin resistance, or a pneumococcal penicillin-resistance phenotype, capture that in resistancePhenotypes and preserve any visible AST calls.\n"
        ...
        "Use carbapenemaseResult and carbapenemaseClass only when clearly shown in the image; otherwise leave them as 'Not specified'.\n"
        ...
        "If the image has a visible carbapenemase line or label, transcribe it into visibleText even if you are uncertain how to structure it.\n"
