...
_CLINICAL_SAFETY_GUARDRAILS = (
    ...
    "ENDOCARDITIS — critical rules (2023 Duke-ISCVID criteria, Fowler et al., CID 2023; "
    "original Modified Duke: Durack et al., Am J Med 1994; Li et al., CID 2000; "
    "AHA/IDSA IE guideline, Baddour et al., Circulation 2015):\n"
    ...
    "Cephalexin at standard doses (500mg QID) does NOT achieve adequate bone concentrations for osteomyelitis "
    "(Thabit et al., BMC Infect Dis 2019 — bone penetration ratio insufficient; OVIVA trial did not use cephalexin). "
    "Do NOT use cephalexin for bone infections.\n"
    "  - Rifampin is MANDATORY for prosthetic joint infections (PJI) with retained hardware — always in combination, never monotherapy "
    "(IDSA PJI guideline, Osmon et al., CID 2013). Start rifampin only after bacteremia has cleared and surgical debridement is complete.\n\n"
    ...
    "(de Gans & van de Beek, NEJM 2002 — dexamethasone before or with first antibiotic dose reduced mortality in pneumococcal meningitis; "
    "Brouwer, Cochrane 2015 — confirmed benefit in high-income settings). Dexamethasone 0.15 mg/kg q6h × 4 days.\n"
    ...
    "(IDSA 2010 Cryptococcal guideline, Perfect, CID 2010). "
    "DEFER ART for 4-6 weeks (COAT trial, Boulware, NEJM 2014 — early ART increases mortality from IRIS).\n\n"

    "CANDIDEMIA — critical rules (IDSA 2016 Candidiasis guideline, Pappas et al., CID 2016):\n"
    ...
    "  - Remove ALL central venous catheters if possible (strong recommendation).\n"
    "  - Ophthalmology consult within 1 week (ideally 72 hours) to rule out endophthalmitis — "
    "dilated fundoscopic exam after blood culture clearance (guideline recommendation).\n"
    "  - Duration: 14 days from FIRST NEGATIVE blood culture, not from start of treatment.\n"
    "  - Repeat blood cultures every 24-48h until clearance documented.\n"
    "  - Echocardiogram if clinical suspicion of endocarditis (prolonged candidemia, prosthetic valve, IVDU).\n"
    "  - Candida auris: check local epidemiology, may require echinocandin resistance testing. CDC urgent threat.\n\n"
    ...
    "(BLING III trial, Dulhunty et al., JAMA 2022 — continuous/extended infusion pip-tazo and meropenem reduced 90-day mortality in sepsis):\n"
    ...
    "  - SAB uncomplicated: 14 days from first negative culture (Holland et al., JAMA 2014 — SAB outcome data; "
    "Thwaites et al., Lancet 2018 ARREST trial — rifampin adjunctive therapy did not improve outcomes). "
    "Strict criteria for 'uncomplicated' (all must be met): "
    "cultures clear within 72h, no endovascular source on echo (TTE +/- TEE), no metastatic infection on imaging, "
    "no prosthetic material (valves, joints, vascular grafts), no immunosuppression, no IVDU. "
    ...
    "SURGICAL PROPHYLAXIS — not treatment (Bratzler et al., Am J Health-Syst Pharm 2013 — ASHP/IDSA/SIS/SHEA guideline):\n"
    ...
    "  - Aspergillus (invasive): voriconazole is FIRST-LINE (Herbrecht et al., NEJM 2002 — voriconazole superior to AmB; "
    "IDSA 2016 Aspergillosis guideline, Patterson et al., CID 2016). "
    "Dosing: 6 mg/kg IV q12h × 2 loads, then 4 mg/kg IV q12h, "
    ...
    "and no QTc prolongation (actually shortens QTc — Marty et al., Lancet Haematol 2016 SECURE trial). "
    ...
    "MAC (Mycobacterium avium complex) PULMONARY (ATS/IDSA 2020 NTM guideline, Daley et al., CID 2020):\n"
    "  - Nodular/bronchiectatic: azithromycin 500mg + ethambutol 15mg/kg + rifampin 600mg — "
    "THREE TIMES WEEKLY (MWF), not daily. "
    ...
    "THE 10% CROSS-REACTIVITY MYTH IS FALSE (Blumenthal, JACI 2019; Picard, JACI Pract 2019):\n"
    ...
    "SOURCE CONTROL — antibiotics alone are insufficient without adequate source control "
    "(Sendi & Zimmerli, Lancet Infect Dis 2017 — conceptual framework; IDSA PJI guideline, Osmon et al., CID 2013):\n"
    "  - CENTRAL VENOUS CATHETER (CVC) / PICC: ALWAYS remove for S. aureus bacteremia, candidemia, "
    "tunnel/port-pocket infection, and clinical sepsis with no other source. "
    "Salvage (lock therapy + systemic antibiotics) is acceptable ONLY for CoNS line infections in a stable patient "
    "with limited venous access and a functioning non-tunneled catheter. "
    "Do NOT attempt salvage for S. aureus, Candida, P. aeruginosa, or mycobacterial line infections.\n"
    "  - ABSCESS DRAINAGE: abscesses >2 cm generally require drainage (percutaneous or surgical). "
    "Liver abscess: drainage if >5 cm or no response to antibiotics at 48-72h. "
    "Psoas abscess: CT-guided drainage. Empyema: chest tube or VATS. "
    "Peritonsillar abscess: needle aspiration or I&D. Epidural abscess: emergent neurosurgical decompression if neurological deficit.\n"
    "  - PROSTHETIC JOINT INFECTION (PJI) — surgical decision (Osmon et al., CID 2013):\n"
    "    DAIR (debridement, antibiotics, implant retention): eligible ONLY if: "
    "symptoms <3 weeks, well-fixed implant, susceptible organism (esp. Staphylococcus), no sinus tract, "
    "acute hematogenous or early postoperative (<30 days). Rifampin combination MANDATORY for staphylococcal PJI with DAIR.\n"
    "    2-stage exchange: standard for chronic PJI (>3 weeks symptoms), sinus tract, resistant organism, "
    "or failed DAIR. 6 weeks IV antibiotics between explant and reimplant.\n"
    "    1-stage exchange: selected cases with good bone stock, susceptible organism, no sinus tract.\n"
    "  - CARDIAC DEVICE (CIED) EXTRACTION: remove entire system (generator + all leads) for definite CIED infection "
    "(pocket infection, endocarditis, persistent bacteremia). Partial removal is NOT adequate. "
    "Lead extraction is a specialized procedure — refer to experienced center.\n"
    "  - NECROTIZING FASCIITIS: emergent surgical exploration and debridement is THE primary treatment. "
    "Do NOT delay surgery for imaging or antibiotics. Repeat debridement at 24-48h until tissue margins are clean.\n"
    "  - DIABETIC FOOT INFECTION (IWGDF/IDSA 2023): probe-to-bone positive suggests osteomyelitis "
    "(Grayson et al., JAMA 1995 — LR+ 6.4). Moderate-severe DFI with devitalized tissue requires surgical debridement. "
    "Amputation may be necessary for extensive gangrene or non-reconstructable vascular disease.\n"
    "  - RULE: when recommending antibiotics for a deep-seated infection, ALWAYS address source control in the same response. "
    "State whether drainage, debridement, or device removal is needed and when.\n\n"

    "STEWARDSHIP AND DE-ESCALATION — narrow when cultures return "
    "(De Bus et al., ICM 2020 — de-escalation safe in ICU; Tabah et al., Lancet Infect Dis 2016 — "
    "de-escalation associated with lower mortality in ICU sepsis):\n"
    "  - De-escalation timing: review empiric antibiotics at 48-72h when culture and susceptibility data are available. "
    "If the organism is identified and susceptible to a narrower agent, switch.\n"
    "  - MSSA: de-escalate from vancomycin to cefazolin IV or nafcillin IV. "
    "Vancomycin is INFERIOR to beta-lactams for MSSA (slower bactericidal activity, worse clinical outcomes).\n"
    "  - ESBL-negative GNR: de-escalate from carbapenem to ceftriaxone or cefepime if susceptible. "
    "Do NOT continue meropenem for a ceftriaxone-susceptible E. coli.\n"
    "  - Antifungal: stop empiric echinocandin if blood cultures remain negative at 96h, "
    "patient is clinically improving, and no risk factors for invasive candidiasis persist.\n"
    "  - Anti-MRSA: stop vancomycin/linezolid if cultures grow only MSSA or GNR with no MRSA identified, "
    "and nasal MRSA screen is negative (NPV >95% for MRSA pneumonia).\n"
    "  - When NOT to de-escalate: MRSA endocarditis (vancomycin is directed therapy, not empiric), "
    "polymicrobial infections requiring broad coverage, immunocompromised patients with ongoing neutropenia.\n"
    "  - RULE: when reporting culture results, ALWAYS recommend de-escalation explicitly if the current regimen is broader than needed. "
    "Do not leave empiric broad-spectrum therapy running when directed narrow-spectrum therapy is possible.\n\n"

    "SPELLBERG SHORT-COURSE EVIDENCE — shorter IS better (Spellberg & Rice, JAMA Intern Med 2017; CID 2019; "
    "ACP Best Practice Advice, Lee et al., Ann Intern Med 2021):\n"
    "  - >120 RCTs show short courses non-inferior to long courses for most common infections.\n"
    "  - Longer courses increase adverse effects ~5% per additional day (Vaughn et al., JAMA Intern Med 2019 — "
    "each additional day of antibiotics beyond minimum increases risk of adverse drug events).\n"
    "  - Community-acquired pneumonia: minimum 5 days (ATS/IDSA 2019); short course non-inferior even in PSI class IV-V "
    "(Uranga et al., JAMA Intern Med 2016 — 5d vs 10d, 93.1% vs 80.3% success, p=0.04). "
    "8 RCTs confirm short course (el Moussaoui 2006, Dunbar 2003).\n"
    "  - Nosocomial/VAP: 7-8 days non-inferior to 10-15 (Chastre et al., JAMA 2003).\n"
    "  - Acute bacterial sinusitis: 5 days non-inferior to 10 (Falagas meta-analysis 2009).\n"
    "  - AECOPD / acute bronchitis: ≤5 days (21 RCTs, El Moussaoui meta-analysis 2008).\n"
    "  - Uncomplicated cellulitis: 5-6 days (Hepburn, Arch Intern Med 2004; IDSA 2014 SSTI guideline, Stevens et al., CID 2014).\n"
    "  - Empiric febrile neutropenia: stop when afebrile ≥72h regardless of ANC recovery "
    "(multiple RCTs; Spellberg synthesis 2019).\n"
    "  - Vertebral osteomyelitis: 6 weeks non-inferior to 12 weeks (Bernard et al., Lancet 2015).\n"
    "  - EXCEPTIONS where short course is NOT supported: TB (slowly replicative, requires ≥6mo), "
    "acute otitis media in children 6-23mo (Hoberman, NEJM 2016 — 5d inferior to 10d), "
    "SAB/endocarditis (minimum durations apply per clock-start conventions above).\n"
    "  - RULE: when recommending a duration, cite the evidence for the specific course length. "
    "If recommending longer than evidence-based minimum, state why (e.g., immunosuppression, slow clinical response, undrained source).\n"
)
...
def narrate_opat_answer(
    *,
    ...
    prompt = (
        "You are an infectious diseases consultant assessing whether a patient is a candidate for OPAT "
        "(outpatient parenteral antibiotic therapy) per IDSA 2019 OPAT guideline (Norris et al., CID 2019).\n"
        + context_block +
...
def narrate_sepsis_management_answer(
    *,
    ...
    prompt = (
        ...
        "HOUR-1 BUNDLE (Surviving Sepsis Campaign 2021 — Evans et al., ICM 2021):\n"
...
def narrate_travel_medicine_answer(
    *,
    ...
    prompt = (
        ...
        + context_block +
        "Use the following clinical framework:\n\n"
        "IMMEDIATE PRIORITY — RULE OUT MALARIA (WHO 2022 Malaria Treatment Guidelines, 3rd edition; CDC Yellow Book 2024):\n"
        ...
        "  - Enteric fever (typhoid/paratyphoid Salmonella typhi/paratyphi): fever, relative bradycardia, rose spots, hepatosplenomegaly, diarrhoea or constipation. Blood culture (positive in 60-80% in first week). Treat: ceftriaxone 2g OD ×7-14 days (or azithromycin 500mg OD ×7d for uncomplicated); avoid fluoroquinolones unless susceptibility confirmed (high resistance in South Asia — Andrews, Lancet Glob Health 2018).\n"
        ...
        "  Suggests helminthic infection: Strongyloides (can disseminate in immunosuppressed — stool microscopy + Strongyloides serology; Buonfrate, PLoS NTD 2013), schistosomiasis (serology + urine/stool ova), filariasis, toxocariasis, trichinellosis.\n"
...
def narrate_biomarker_interpretation_answer(
    *,
    ...
    prompt = (
        ...
        "PROCALCITONIN (PCT) — thresholds per Schuetz, Cochrane 2017; Tan, J Intensive Care 2018 meta-analysis:\n"
        ...
        "  - Stopping rule: PCT drop >80% from peak, or absolute value <0.5 ng/mL — safe to stop antibiotics in many contexts (PRORATA — Bouadma, Lancet 2010; de Jong, Lancet ID 2016 meta-analysis).\n"
        ...
        "BETA-D-GLUCAN (BDG) — per Karageorgopoulos, CID 2011 meta-analysis (sens 77%, spec 85%):\n"
        ...
        "GALACTOMANNAN (GM) — per Zou, PLoS ONE 2012 meta-analysis (serum sens 71%, spec 89%; BAL sens 87%, spec 89%):\n"
...
def narrate_fluid_interpretation_answer(
    *,
    ...
    prompt = (
        ...
        "CSF INTERPRETATION (Spanos, JAMA 1989 — CSF glucose LR+ 18 for bacterial; Nigrovic, Pediatrics 2002):\n"
        "  Bacterial meningitis: WBC >1000 (predominantly neutrophils >80%), glucose <2.2 mmol/L or CSF:serum glucose ratio <0.4 (LR+ 18 for bacterial), protein >1.0 g/L, turbid appearance. Gram stain positive in 60-80%. Treat immediately — do not delay for CT if no focal neurology and no papilloedema.\n"
        ...
        "PLEURAL FLUID — Light's criteria (Light, Ann Intern Med 1972; exudate if ANY criterion met):\n"
        ...
        "SYNOVIAL FLUID — septic arthritis (Margaretten, JAMA 2007 — WBC >50k LR+ 7.7):\n"
        "  - WBC >50,000 cells/µL strongly suggests septic arthritis (LR+ 7.7, specificity ~95%); >100,000 is near-diagnostic.\n"
...
def narrate_allergy_delabeling_answer(
    *,
    ...
    prompt = (
        ...
        "CROSS-REACTIVITY — penicillin to cephalosporins (Blumenthal, JACI 2019 — R1 side chain analysis; Picard, JACI Pract 2019):\n"
        "  - True cross-reactivity rate is ~1-2% (not the historically cited 10% — based on flawed 1960s data with penicillin-contaminated cephalosporins).\n"
        "  - Cross-reactivity is driven by R1 side chain similarity, NOT the beta-lactam ring.\n"
        "  - High cross-reactivity pairs (~2%, avoid if penicillin anaphylaxis): amoxicillin ↔ cefadroxil, cephalexin, cefprozil; ampicillin ↔ cefaclor.\n"
        "  - Low/negligible cross-reactivity (<0.5%): ceftriaxone, cefazolin, cefepime, ceftazidime with penicillin (different R1 side chains).\n"
...
def narrate_hiv_initial_art(
    *,
    ...
    prompt = (
        ...
        "  - Pregnancy: DTG is recommended including first trimester (NTD risk ~0.2%, similar to background — Zash, Tsepamo study, NEJM 2019). "
...
def narrate_hiv_prep(
    *,
    ...
    prompt = (
        ...
        "     - Superior to oral TDF/FTC in clinical trials (HPTN 083 — Landovitz, NEJM 2021; HPTN 084 — Delany-Moretlwe, NEJM 2022).\n"
...
def narrate_hiv_pregnancy(
    *,
    ...
    prompt = (
        ...
        "     - DTG is recommended INCLUDING first trimester — NTD risk ~0.2%, comparable to background rate (Zash, Tsepamo study, NEJM 2019).\n"
